...
function Notes(props) {
    ...
    const { notes, getNotes, editNote } = context;  // destructuring of notes from NoteState.js and value is coming from provider in notestate.js
    ...
    return (
        <>
            ...
            <div className="row my-4 ">
                <h2>Your Notes</h2>
                <div className='container mx-2'>{notes.length === 0 && "Note notes are available"}</div>
                {notes.map((note) => {
